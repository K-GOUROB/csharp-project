...
namespace online_voting_application
{
    public partial class Form3 : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
           ...
           ,[password])
     VALUES
           ('" + textBox14.Text + "', '" + textBox6.Text + "', '" + textBox5.Text + "', '" + textBox9.Text + "', '" + cmbGender.SelectedItem.ToString() + "', '" + textBox7.Text + "', '" + textBox3.Text + "', '" + textBox4.Text + "', '" + dateTimePicker1.Text + "', '" + textBox1.Text + "', '" + textBox15.Text + "', '" + textBox11.Text + "')", con);
